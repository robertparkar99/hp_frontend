            ...
            <div className={`absolute inset-0 pointer-events-none ${selected ? 'opacity-100' : 'opacity-0'} transition-opacity duration-150`}>
                ...
                <div className="absolute -top-[40px] left-1/2 -translate-x-1/2 flex items-center gap-[6px] pointer-events-auto z-[9999] select-none">
                    ...
                    <div
                        ...
                        onPointerDown={(e) => { e.preventDefault(); controls.onRotateStart(e); }}
                    ...
                    {/* Move Button */}
                    <div
                        className="w-[40px] h-[40px] rounded-full bg-white shadow-sm border border-neutral-200 text-neutral-600 flex items-center justify-center cursor-grab active:cursor-grabbing hover:bg-neutral-50 transition-colors move-handle pointer-events-auto"
                    ...
                    {controls.onDelete && (
                        <div
                            className="w-[40px] h-[40px] rounded-full bg-white shadow-sm border border-neutral-200 text-red-500 flex items-center justify-center cursor-pointer hover:bg-red-50 hover:border-red-200 transition-colors transform-handle pointer-events-auto"
                            onPointerDown={(e) => { e.preventDefault(); e.stopPropagation(); controls.onDelete!(); }}
                            title="Delete"
                        >
                ...
                {!noResize && (
                    <>
                        <div data-dir="nw" className="absolute -top-[6px] -left-[6px] w-[12px] h-[12px] bg-white border-[1.5px] border-[#8b3dff] rounded-full cursor-nwse-resize shadow-sm transform-handle pointer-events-auto" style={{ touchAction: "none" }} onPointerDown={(e) => { e.preventDefault(); controls.onResizeStart(e); }} onPointerMove={controls.onResizeMove} onPointerUp={handlers.onPointerUp} onPointerCancel={handlers.onPointerCancel} />
