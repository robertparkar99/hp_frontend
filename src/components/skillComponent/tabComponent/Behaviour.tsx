...
//     try {
//       const res = await fetch(
//         `https://hp.triz.co.in/table_data?table=s_skill_knowledge_ability&filters[sub_institute_id]=3&filters[classification]=behaviour&group_by=classification_category`
//       );
//       const data = await res.json();
//       setCategoryOptions(
//         Array.from(
...
//   //     // );
//   //         const res = await fetch(`https://hp.triz.co.in/skill_library/create?type=API&token=929|fRP90F3cElCvyigHxpTytEJ5GPUr4ZJddh80PTxl205798a3&sub_institute_id=3&org_type=Healthcare&skill_id=2524&formType=behaviour`);
//   //     const data = await res.json();
//   //     console.log('data api',data.userBehaviourData);
...
//     //     </div>
//     //   ),
//     //   selector: (row: BehaviourEntry) => row.proficiency_level ?? "",
//     //   sortable: true,
//     //   wrap: true,
//     // },
//          {
