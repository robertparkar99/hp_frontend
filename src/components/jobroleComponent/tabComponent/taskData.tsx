          ...
          : [
              {
                ...
                jobrole:
                  data.usertaskData.jobrole || data.usertaskData.job_role,
                description: data.usertaskData.description,
                category: data.usertaskData.category,
                sub_category: data.usertaskData.sub_category,
                skillTitle: data.usertaskData.skillTitle,
                created_by_user:
                  data.usertaskData?.first_name +
                  " " +
                  data.usertaskData?.last_name,
