...
//     console.log('Sample data item:', data[0]); // Debug log to see actual structure
...
//       // Group by skills_category (dimension) and sum weightage
//       const dimensionTotals: { [key: string]: number } = {};

//       items.forEach(item => {
//         // Map the actual API field to our expected dimensions
//         let dimension = item.skills_category;

//         // Handle potential field name variations or mappings
//         if (dimension && typeof dimension === 'string') {
//           // Normalize dimension names to match our expected values
//           dimension = dimension.trim();

//           // Map common variations to our standard dimensions
...
//         // Only process if dimension is one of our expected values
//         if (DIMENSIONS.includes(dimension)) {
//           dimensionTotals[dimension] = (dimensionTotals[dimension] || 0) + (item.weightage || 0);
//         }
//       });

//       console.log('Dimension totals for', category, ':', dimensionTotals); // Debug log
