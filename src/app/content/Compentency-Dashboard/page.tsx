"use client";
import CompetencyDashboard from "@/app/content/Compentency-Dashboard/Dashboard";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className={`transition-all duration-300 ${isSidebarOpen ? "md:ml-76" : "md:ml-24"} p-2`}>
        <CompetencyDashboard/>
      </div>
    </>
  );
