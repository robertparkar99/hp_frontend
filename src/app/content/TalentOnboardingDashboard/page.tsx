"use client";
import Index from '../Telent-management/Talent-onboarding-Dashbaord/Index';
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className={`transition-all duration-300 ${isSidebarOpen ? "md:ml-76" : "md:ml-24"} ml-0 px-2 md:p-2`}>
        <Index/>
      </div>
    </>
  );
