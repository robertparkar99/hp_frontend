...
// //             <p className="text-success">Coverage: <span className="font-bold">{payload[0].value}%</span></p>
// //             <p className="text-warning">Avg Gap: <span className="font-bold">{payload[1].value.toFixed(1)} pts</span></p>
// //           </div>
// //         </div>
// //       );
// //     }
...
// //     <Card className="p-6">
// //       <div className="mb-4">
// //         <h3 className="text-lg font-semibold text-foreground">Skill Performance Trends</h3>
// //         <p className="text-sm text-muted-foreground">Track coverage % and average gap evolution over time</p>
// //       </div>
...
// //           <span className="font-semibold">AI Insight:</span> Technical competency improved by <span className="font-bold text-success">+0.8 points</span> after Q2 training initiative. Coverage increased <span className="font-bold text-success">+5%</span> quarter-over-quarter.
// //         </p>
// //       </div>
// //     </Card>
// //   );
