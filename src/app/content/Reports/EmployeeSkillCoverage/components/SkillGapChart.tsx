...
//     if (gap >= 2) return "hsl(0 84% 60%)"; // destructive
//     if (gap >= 1) return "hsl(38 92% 50%)"; // warning
...
//             <p className="text-muted-foreground">Gap: <span className="font-bold text-foreground">{data.gap.toFixed(1)} points</span></p>
//             <p className="text-muted-foreground">Expected: <span className="font-medium">{data.expectedScore.toFixed(1)}</span></p>
//             <p className="text-muted-foreground">Actual: <span className="font-medium">{data.actualScore.toFixed(1)}</span></p>
//           </div>
//         </div>
//       );
//     }
...
//     <Card className="p-6">
//       <div className="mb-4">
//         <h3 className="text-lg font-semibold text-foreground">Top Skill Deficiencies</h3>
//         <p className="text-sm text-muted-foreground">Ranked by average gap (Expected - Actual proficiency)</p>
//       </div>
