...
import EmployeeDirectory from "@/app/content/Reports/employee/EmployeeDirectory";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className={`transition-all duration-300 ${isSidebarOpen ? "lg:ml-[304px]" : "lg:ml-20"} ml-0 p-4 md:p-6`}>
        <EmployeeDirectory />
      </div>
    </>
  );
