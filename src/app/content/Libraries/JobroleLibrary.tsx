...
import MasterTable from '@/components/jobroleComponent/masterJobrole';
import TreeView from '@/components/jobroleComponent/treeView';
import AddSkillView from '@/components/jobroleComponent/addTreeView';
      ...
      {isLoading && (
        ...
        >
          <div className="flex flex-col items-center justify-center min-h-screen bg-white space-y-6">
            ...
            {/* Optional subjobrole or loader bar */}
