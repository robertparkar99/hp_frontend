...
// //                       <div className="text-sm text-muted-foreground">Ready 1-2 Years</div>
// //                     </div>
// //                     <div className="text-center">
...
// //                       <span className="text-sm">Performance review completed - John Doe</span>
// //                     </div>
...
// //                       <span className="text-sm">Promotion recommendation pending approval</span>
// //                     </div>
...
// //                       <span className="text-sm">New succession candidate identified</span>
// //                     </div>
...
// //                       <div className="text-lg font-bold text-primary">{[8.9, 7.8, 9.1, 8.4][index]}/10</div>
// //                       <Badge variant={index % 2 === 0 ? "secondary" : "outline"} className="text-xs">
...
// //                   {/* <EnhancedButton variant="secondary" className="h-auto p-4 flex-col gap-2"> */}
// //                     <CheckCircle className="h-6 w-6" />
// //                     <span>Complete Reviews</span>
// //                     <span className="text-xs text-muted-foreground">3 pending</span>
// //                   {/* </EnhancedButton> */}
// //                   {/* <EnhancedButton variant="accent" className="h-auto p-4 flex-col gap-2"> */}
// //                     <Star className="h-6 w-6" />
// //                     <span>Nominate for Succession</span>
// //                     <span className="text-xs text-muted-foreground">2 candidates</span>
// //                   {/* </EnhancedButton> */}
// //                   {/* <EnhancedButton variant="outline" className="h-auto p-4 flex-col gap-2"> */}
// //                     <Users className="h-6 w-6" />
// //                     <span>Team Analytics</span>
// //                     <span className="text-xs text-muted-foreground">View detailed</span>
// //                   {/* </EnhancedButton> */}
// //                 </div>
// //               </CardContent>
// //             </Card>
...
// //                 <div className="space-y-4">
// //                   <div className="flex items-center justify-between">
// //                     <span className="text-sm font-medium">Progress to Senior Developer</span>
...
// //                       <div className="text-sm font-medium text-success">Completed Skills</div>
// //                       <div className="text-xs text-muted-foreground mt-1">React, TypeScript, Node.js</div>
// //                     </div>
// //                     <div className="p-4 rounded-lg bg-warning/10 border border-warning/20">
// //                       <div className="text-sm font-medium text-warning">Skills in Progress</div>
// //                       <div className="text-xs text-muted-foreground mt-1">System Design, Leadership</div>
// //                     </div>
// //                   </div>
// //                 </div>
// //               </CardContent>
...
// //                     <Badge variant="secondary" className="bg-success text-success-foreground">Promotion</Badge>
// //                     <span className="text-sm">Promoted to Senior Developer</span>
// //                     <span className="text-xs text-muted-foreground ml-auto">Next month</span>
// //                   </div>
// //                   <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
// //                     <Badge variant="secondary" className="bg-primary text-primary-foreground">Review</Badge>
// //                     <span className="text-sm">Excellent performance rating (8.7/10)</span>
// //                     <span className="text-xs text-muted-foreground ml-auto">Last week</span>
// //                   </div>
// //                   <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
// //                     <Badge variant="secondary" className="bg-accent text-accent-foreground">Goal</Badge>
// //                     <span className="text-sm">Q3 project objectives completed</span>
...
// //               <p className="text-muted-foreground">Here's what's happening with your talent management today.</p>
// //             </div>
...
//     { key: "appraisala", label: "Appraisala", icon: Users },
//     { key: "succession", label: "Succession", icon: UserCheck },
//     { key: "report", label: "Report", icon: MessageSquare },
//     { key: "profile", label: "Profile", icon: MessageSquare },
//   ];
...
//         <div className="space-y-6">
//           <div>
//             <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Welcome back, {userName.split(' ')[0]}!</h1>
//             <p className="text-gray-600 mt-1">Here's what's happening with your talent management today.</p>
//           </div>
