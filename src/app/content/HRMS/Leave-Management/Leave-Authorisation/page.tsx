...
import LeaveAuthorization from "@/app/content/HRMS/Leave-Management/Leave-Authorisation/LeaveAuthorisation";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className={`transition-all duration-300 ${isSidebarOpen ? "lg:ml-76" : "lg:ml-24"} p-2 w-full`}>
        <LeaveAuthorization />
      </div>
    </>
  );
