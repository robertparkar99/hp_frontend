...
import { Plus, Save, X, Building, User } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import DataTable, { TableColumn, TableStyles } from 'react-data-table-component';
import Icon from '@/components/AppIcon';
import { startLeaveAllocationTour } from './LeaveAllocationTourSteps';
...
export default function LeaveAllocation() {
  ...
  useEffect(() => {
    ...
    if (isTriggered && !isCompleted) {
      // Start the tour from external file
      startLeaveAllocationTour(166).catch(err => console.error('Error starting tour:', err));
    }
