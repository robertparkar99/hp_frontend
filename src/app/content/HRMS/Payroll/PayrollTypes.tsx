...
//     setFilters((prev) => ({
//       ...prev,
//       [key]: key === "srno" ? value : value.toLowerCase(),
//     }));
//   };
...
//             type="text"
//             placeholder="Search..."
//             onChange={(e) => handleColumnFilter("srno", e.target.value)} // ✅ fixed
...
//       sortable: false, // Sr.No should not be sorted
//       width: "80px",
//     },
//     {
//       name: (
...
//     //     ? (row.payroll_percentage !== null && row.payroll_percentage !== undefined ? row.payroll_percentage.toString() : "-")
//     //     : (row.payroll_percentage !== null && row.payroll_percentage !== undefined ? `${row.payroll_percentage}` : "-"),
//     //   sortable: true,
//     //   cell: (row) => (
//     //     <span>
...
//         type="text"
//         placeholder="Search..."
//         onChange={(e) => handleColumnFilter("payroll_percentage", e.target.value)} // ✅ filter actual field
//         style={{
//           width: "100%",
//           padding: "4px",
//           fontSize: "12px",
...
//     </div>
//   ),
//   selector: (row) => (row.day_count ? "Yes" : "No"), // ✅ what table sees
//   sortable: true,
//   cell: (row) => (
//     <span
//       className={`px-2 py-1 rounded-full text-xs font-medium ${
