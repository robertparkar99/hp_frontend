...
import Index from "../Reports/OrganizationReport";
// import SkillRec from "./SkillRec";
  ...
  return (
    <div>
      ...
      {/* <Sidebar mobileOpen={mobileOpen} onClose={handleCloseMobileSidebar}  /> */}
        <div className={`transition-all duration-300 ${isSidebarOpen ? "ml-76" : "ml-24"} p-4 md:p-6`}>
      {/* <SkillRec /> */}
      <Index/>
      </div>
    </div>
