  ...
  return (
    <div className="w-full p-6">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        {/* Profile Card */}
        <div className="w-full  h-[260px] md:w-[600px] bg-white rounded-lg shadow-[0px_4px_4px_0px_rgba(71,160,255,0.45)] border border-[#47a0ff]/40 relative">
          <div className="titleDiv flex bg-[#47a0ff] px-4 rounded-t-lg h-[calc(var(--spacing) * 20]">
            <div className="empImg w-[fit-content] " style={{
              ...
              {userDetails && userDetails.image && userDetails.image !== '' ? (
                <img
                  ...
                  alt="Profile picture"
                  className="w-[100px] h-[100px] rounded-full border-1 border-[#ddd]"
                />
              ) : (
                <img
                  ...
                  alt="Profile picture"
                  className="w-[100px] h-[100px] bg-white rounded-full border-1 border-[#ddd]"
                />
              )}
            </div>
            <div className="empName pl-10 mt-4">
              ...
              <div className="lg:flex md:block sm:block mt-2">
                <p className="mr-2 text-[#686868]">Designation: {sessionData.userProfile}</p>
                <p className="mx-3 text-[#686868]">Department: {userDetails?.userDepartment}</p>
              </div>
            </div>
          ...
          <div className="text-[#686868] px-8 pt-10 text-[15px] font-normal font-poppins leading-[30px]">
            Email ID: {userDetails?.email}
          </div>
          <div className="detailDiv lg:flex md:block sm:block pb-6">
            <div className="leftData pl-8">

              <div className="text-[#686868] text-[15px] font-normal font-poppins leading-[30px]">
            ...
            <div className="rightData pl-6">
              <div className="text-[#686868] text-[15px] font-normal font-poppins leading-[30px]">
                Employment Type: Full-Time
              </div>
              <div className="text-[#686868] text-[15px] font-normal font-poppins leading-[30px]">
                Jobrole: {userDetails?.userJobrole}
              </div>
            </div>
        ...
        {/* Certificate Card */}
        <div className="w-full h-[260px] md:w-[40%] p-5 bg-white rounded-[15px] shadow-[0px_4px_4px_0px_rgba(245,161,161,0.45)] border border-[#ffd2d2]">
          <div className="w-full  relative">
            ...
            <div className="certicateDiv h-[180px] overflow-scroll hide-scroll">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-[300px] h-[350px] p-5 bg-white rounded-[15px] shadow-[0px_4px_4px_0px_rgba(255,174,76,0.45)] border border-[#ffd570]">
          <div className="w-full h-full relative">
            ...
            <div className="taslDiv h-[180px] overflow-scroll hide-scroll">
