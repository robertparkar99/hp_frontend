...
//    onUpdate: ({ editor }) => {
//       const html = editor.getHTML(); // or editor.getText()
...
//       {/* Editor */}
//       <EditorContent editor={editor} className="resize px-2" style={{resize : "both"}} />
//       {!value && !editor.getText() && (
//         <span className="text-gray-400 text-sm absolute">{placeholder}</span>
//       )}
//     </div>
//   );
// }
