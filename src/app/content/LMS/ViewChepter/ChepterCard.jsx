...
const ChapterCard = ({
  ...
  try {
    ...
    const url = `${sessionInfo.url}/lms/content_master/${content.id}/edit?type=API&sub_institute_id=${
      sessionInfo.sub_institute_id || 1
    }`;
    const response = await fetch(url);
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 ">
                        ...
                        {/* {totalContentCount > 0 && (
                          <Badge variant="secondary" className="text-[13px] text-blue-700 bg-blue-100 hover:bg-blue-200">
                            {totalContentCount} {totalContentCount === 1 ? 'item' : 'items'}
                          </Badge>
                        )} */}
                        {totalContentCount > 0 && (
                          <Badge variant="secondary" className="text-[13px] text-blue-700 bg-blue-100 hover:bg-blue-200 rounded-full border border-blue-200">
                            {totalContentCount} {totalContentCount === 1 ? 'item' : 'items'}
                          </Badge>
                        )}
                      </div>
                ...
                <div className="flex items-center gap-2 ml-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="h-8 px-3 bg-red-50 text-red-700 border-red-200 hover:bg-red-100 hover:text-red-800"
                    onClick={(e) => {
                      e.stopPropagation();
                      handleDeleteClick();
                    }}
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <div className="flex items-center gap-2">
                                        <Button
                                          size="sm"
                                          variant="outline"
                                          className="h-7 w-7 p-0 bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100"
                                        ...
                                        <Button
                                          size="sm"
                                          variant="outline"
                                          className="h-7 w-7 p-0 bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100"
                                          onClick={(e) => {
                                            e.stopPropagation();
                                        ...
                                        <Button
                                          size="sm"
                                          variant="outline"
                                          className="h-7 w-7 p-0 bg-red-50 text-red-700 border-red-200 hover:bg-red-100"
