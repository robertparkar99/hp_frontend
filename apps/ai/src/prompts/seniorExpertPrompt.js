...
Existing Skills:
${JSON.stringify(
        Array.isArray(groundingData.existingSkills)
          ? groundingData.existingSkills
          : [],
        null,
        2
      )}
...
Existing Knowledge:
${JSON.stringify(
        Array.isArray(groundingData.existingKnowledge)
          ? groundingData.existingKnowledge
          : [],
        null,
        2
      )}
...
Existing Abilities:
${JSON.stringify(
        Array.isArray(groundingData.existingAbilities)
          ? groundingData.existingAbilities
          : [],
        null,
        2
      )}
...
Existing Attitudes:
${JSON.stringify(
        Array.isArray(groundingData.existingAttitudes)
          ? groundingData.existingAttitudes
          : [],
        null,
        2
      )}
...
Existing Behaviors:
${JSON.stringify(
        Array.isArray(groundingData.existingBehaviors)
          ? groundingData.existingBehaviors
          : [],
        null,
        2
      )}
...
Existing Critical Work Functions:
${JSON.stringify(
        Array.isArray(groundingData.existingCWFKT)
          ? groundingData.existingCWFKT
          : [],
        null,
        2
      )}
...
Ensure the output follows:
- Valid JSON (parsable with no trailing commas).
- Only fields in the structure above.
- Arrays are present even if there is only one item.
...
Use this conversation history to refine the output.
`
      : ''}
